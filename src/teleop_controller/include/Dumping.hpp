...
protected:
    ...
    rclcpp::Subscription<std_msgs::msg::Float64>::SharedPtr dumping_cmd_sub;
    rclcpp::Subscription<std_msgs::msg::Bool>::SharedPtr is_dumping_running_sub;
    ...
    void dumpingCallback(const std_msgs::msg::Float64::SharedPtr msg);

    bool last_dpad_right = false;
    bool last_dpad_left = false;
    bool dumping_belt_running = false;    

    double dumping_cmd = 0.0;
};