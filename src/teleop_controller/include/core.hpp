...
// Global state vars 
extern bool controller_teleop_enabled;
extern bool autonomy_enabled;
...
const double WHEEL_BASE = 0.6761581854;                    //meters
const double WHEEL_RADIUS = 0.1183231568;                  //meters
...
double LINEAR_MAX_TRAVEL = 2; //1.5;
